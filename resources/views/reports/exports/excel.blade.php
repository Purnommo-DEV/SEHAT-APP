<table>
    <thead>
        <tr><th colspan="13">Laporan Operasional {{ $snapshot->event->name }}</th></tr>
        <tr><th colspan="13">{{ $snapshot->event->code }} &middot; {{ $snapshot->event->location }}</th></tr>
        <tr></tr>
        <tr>
            <th>No. Registrasi</th><th>Nama</th><th>NIK</th><th>Nomor HP</th><th>Jenis Kelamin</th><th>Layanan Dipilih</th><th>Status Donor</th><th>Status Kesehatan</th><th>Check-in</th><th>Pos Saat Ini</th><th>Status</th><th>Riwayat Antrean</th><th>Riwayat Layanan</th>
        </tr>
    </thead>
    <tbody>
