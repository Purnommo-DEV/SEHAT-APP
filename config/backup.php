...
return [
    ...
    'notifications' => [
        'notifications' => [
            BackupHasFailedNotification::class => env('BACKUP_NOTIFICATIONS_MAIL_TO') ? ['mail'] : [],
            UnhealthyBackupWasFoundNotification::class => env('BACKUP_NOTIFICATIONS_MAIL_TO') ? ['mail'] : [],
            CleanupHasFailedNotification::class => env('BACKUP_NOTIFICATIONS_MAIL_TO') ? ['mail'] : [],
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATIONS_MAIL_TO') ?: env('MAIL_FROM_ADDRESS', 'backup@example.com'),
